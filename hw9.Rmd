...
The baseline number of skips for when the opening size is at standard size and the solder metal thickness is at standard thickness is 0.39 skips. The main effect of the OpeningM variable is 2.41 skips. The main effect of the OpeningS variable is 5.13 skips. The main effect of the SolderThin variable is 2.28 skips. These are all effects of the variables in isolation.The interaction effect for Opening and Solder is -0.74 skips for OpeningM:SolderThin and 9.65 for OpeningS:SolderThin. 


## Part D

I would recommend using the Opening size small and Solder thickness Thin to AT&T base don the analysis. This is because this variable has the biggest effect on the number of skips and would minimize the number of skips in the manufacturing process. 
